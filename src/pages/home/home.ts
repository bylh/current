...
export class HomePage implements AfterViewInit {
  ...
  ionViewDidEnter() {
    ...
    // let key = account.toKey("passphrase");
    ...
    // let Transaction = Nebulas.Transaction;
    // let tx = new Transaction(100, account, account, "10", 1);
    // tx.signTransaction();
    // console.log("hash:" + tx.hash.toString("hex"));
    // console.log("sign:" + tx.sign.toString("hex"));
    // console.log(tx.toString());
    // let data = tx.toProtoString();
    // console.log(data);
    // tx.fromProto(data);
    // console.log(tx.toString());
    // console.log("address:" + tx.from.getAddressString());

    // let cryptoUtils = Nebulas.CryptoUtils;
