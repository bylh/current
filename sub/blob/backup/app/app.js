...
import {ResumeTemplateStyle , ResumeTemplateContent} from "./data.js"
...
class ReactClass extends React.Component {
	constructor(props) {
		...
		this.interval = 40;
		this.resumeEditorContent = ResumeTemplateContent;

		
		this.styleEditorContent = ResumeTemplateStyle;
	}
